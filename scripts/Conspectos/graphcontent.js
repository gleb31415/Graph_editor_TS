export const rawNodes = [
  ...
  },
  {
    ...
    "data": {
      "section": "механика",
      "grade": "7",
      "text": "Рассматривается движение с постоянной скоростью, выводится формула координаты  x(t), перемещения и времени движения между точками.",
      "number": 2,
      "olympiads": [
        "МОШ, 7-8",
        "Росатом, 7-10",
  ...
  },
  {
    ...
    "data": {
      "section": "механика",
      "grade": "7",
      "text": "Вводятся понятия инерции, инертности, массы и плотности, даётся формула для плотности и средней плотности тела.",
      "number": 3,
      "olympiads": [
        "МОШ, 7-8",
        "Росатом, 8-9",
  ...
  },
  {
    ...
    "data": {
      "section": "механика",
      "grade": "7",
      "text": "Поясняются понятия средней, среднепутевой и относительной скорости, а также формулы их вычисления.",
      "number": 8,
      "olympiads": [
        "МОШ, 7-8",
        "Росатом, 7-9",
  ...
  },
  {
    ...
    "data": {
      "section": "механика",
      "text": "Разбираются кинематические связи для неподвижного и подвижного блоков, выводятся зависимости скоростей концов нити и блока.",
      "grade": "7",
      "number": 9,
      "olympiads": [
        "МОШ, 8-11",
